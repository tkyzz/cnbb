...
/* 
* @desc 获取API数据(备份)
* @param url(string) 接口地址 , param(array) 需要传的参数 , $act(string) 请求的动作
* @author zhuyi
*/
function request_api_BAK($url = '', $param = '', $act = 'get') {
    if (empty($url)) {
        return false;
    }
    $header = "content-type: application/x-www-form-urlencoded;charset=UTF-8";

    // $encode = mb_detect_encoding($param, array("unicode","ASCII","UTF-8","GB2312","GBK","BIG5"));
